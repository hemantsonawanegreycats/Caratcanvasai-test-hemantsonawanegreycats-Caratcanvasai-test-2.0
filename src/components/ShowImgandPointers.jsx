...
import animatedvideofourth from "../assets/animatedvideo4.mp4";
...
function ShowImgandPointers({ comp }) {
  ...
  return (
    <>
      <div ref={scrollParent} className="w-screen bg-amber-100 h-[200vh]">
        <div className="w-screen   h-screen flex bg-white relative ">
            ...
            >
              ...
              >
                ...
                <div className="w-full     lg:py-4   ">
                  <div className="2xl:text-xl leading-tight   ml-4 mb-6 text-white font-semibold capitalize"> Customizable product</div>
